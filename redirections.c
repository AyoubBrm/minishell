...
/*   Updated: 2023/07/21 00:19:43 by abouram          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void out_redirection(t_table *current, t_pipes_n_redirection *pipes_n_redirection, int i)
{
    ...
    if (pipes_n_redirection->trunc_redirect < 0 && current->redirection->file[i])
    {
...
void app_redirection(t_table *current, t_pipes_n_redirection *pipes_n_redirection, int i)
{
    ...
    if (pipes_n_redirection->append_redirection < 0 && current->redirection->file[i])
    {
        ft_printf("bash: %s: Permission denied\n", current->redirection->file[i]);
        global_struct.g_exit_status = 1;
        exit(global_struct.g_exit_status);
